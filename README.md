...
<a href="https://github.com/threat0/insta_down/stargazers/"><img title="Étoiles" src="https://img.shields.io/github/stars/threat0/decBash??color=red"></a>
<a href="https://github.com/threat0/insta_down/network/members"><img title="Fourches" src="https://img.shields.io/github/forks/threat0/decBash??color=red"></a>
<a href="https://github.com/threat0/insta_down/watchers"><img title="En train de regarder" src="https://img.shields.io/github/watchers/threat0/decBash?label=Watchers&color=blue"></a>
<p align="right">
...
```
sudo apt-get update ; git clone https://github.com/threat0/decBash.git ; cd decBash ; python3 setup.py
```
# `Installation sur Termux`
```
clear; pkg update ;pkg install python3 && python ; git clone https://github.com/threat0/decBash.git ; cd decBash ; python3 setup.py
```
## `DEMO : `
<p align="center"> 
  <img src="https://raw.githubusercontent.com/threat0/decBash/master/demo/dec.png" width="700" heigh="500"/></br>
</p>
